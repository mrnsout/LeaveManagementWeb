   ...
   
{
    ...
    public class LeaveRequestsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["LeaveTypeId"] = new SelectList(_context.LeaveTypes, "Id", "Name", "Name");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StartDate,EndDate,LeaveTypeId,DateRquested,RequestComments,Approved,Cancelled,RequestingEmployeeId,Id,DateCreated,DateModified")] LeaveRequest leaveRequest)
        {
